...
\input{content/chapter3/figures/fig_room}

\subsubsection*{入房认证流程}

\textbf{用户端入房}（\texttt{join\_order} 事件）需提交以下字段：
\[
  \{\;\texttt{order\_id},\;\mathrm{PID},\;\texttt{timestamp},\;\texttt{token},\;\texttt{role}\;\}
\]
...
\[
  \{\;\texttt{order\_id},\;\texttt{sender\_pid},\;\texttt{role},\;\texttt{content}\;\}
\]
