...
\hline
目标一 匿名性 & PID强匿名 & 虚拟号码（弱） & 无匿名 & 签名匿名 \\
目标二 认证性 & HMAC-SM3 & 无凭证认证 & 无认证 & 群签名认证 \\
目标三 机密性 & SM4-CBC加密 & 传输加密+明文 & 传输加密+明文 & 加密（可选） \\
目标四 完整性 & SM3+Merkle & 无验证 & 无验证 & 无Merkle \\
目标五 可溯源 & 条件溯源 & 实名查询 & 不可溯源 & 群管理打开 \\
目标六 抗滥用 & 验证码+限流 & 无机制 & 无机制 & 群成员管理 \\
目标七 隐私最小化 & hash-only & 全量可见 & 全量可见 & 条件打开 \\
