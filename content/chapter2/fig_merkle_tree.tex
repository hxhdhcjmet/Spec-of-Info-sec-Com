...
\begin{tikzpicture}[
  ...
  rootnd/.style  = {rectangle, draw, rounded corners=2pt, minimum width=3.4cm, minimum height=0.92cm,
                    font=\small\bfseries, align=center, fill=red!10, draw=red!50!black},
...
\node[lbl, below=0.75cm of L2, red!60!black] {若$m_2$改变};
\node[lbl, above=0.20cm of P12, red!60!black] {父节点改变};
\node[lbl, above=0.20cm of ROOT, red!60!black] {Root 改变};
